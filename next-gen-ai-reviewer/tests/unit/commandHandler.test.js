...
describe("commandHandler", () => {
  ...
  describe("combineTasks", () => {
    it("should combine completions into single comment body", () => {
      const completions = {
        summary: { content: "This PR adds new features", model: "gpt-4o-mini", provider: "chatgpt" },
        review: { content: "Code looks good overall", model: "gpt-4o-mini", provider: "chatgpt" },
        suggestions: { content: "Consider adding tests", model: "gpt-4o-mini", provider: "chatgpt" }
      };
      ...
      expect(body).toContain("summary: chatgpt (gpt-4o-mini)");
      expect(body).toContain("review: chatgpt (gpt-4o-mini)");
      expect(body).toContain("suggestions: chatgpt (gpt-4o-mini)");
    });

    it("should handle null completions", () => {
      const completions = {
        summary: { content: "Summary content", model: "gpt-4o-mini", provider: "chatgpt" },
        review: null,
        suggestions: { content: "Suggestions content", model: "gpt-4o-mini", provider: "chatgpt" }
      };
    ...
    it("should separate sections with dividers", () => {
      const completions = {
        summary: { content: "Summary", model: "gpt-4o-mini", provider: "chatgpt" },
