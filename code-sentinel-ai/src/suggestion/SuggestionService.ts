...
_Generated by ${this.aiAgentName} v${VERSION} (${this.aiProvider.getModel()})_`;
  }
...
_Generated by ${this.aiAgentName} v${VERSION} (${this.aiProvider.getModel()}) • [View PR Files](${this.prService.getPRUrl(prInfo.number)}/files)_`;
