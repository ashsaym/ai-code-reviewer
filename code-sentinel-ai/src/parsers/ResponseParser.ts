...
export class ResponseParser {
   ...
   */
  static createReviewSummary(comments: ReviewComment[], aiSummary?: string, modelName?: string, aiAgentName?: string): string {
    ...
    const agentName = aiAgentName || 'Code Sentinel AI';
    summary += `\n\n_Generated by ${agentName} v${VERSION} (${model})_`;
